    ...
    admin
        ...
        .then((userRecord) => {            
            ...
            User.create({
                ...
                email: request.body.email,
                password: request.body.password,
                avatarURL: "https://firebasestorage.googleapis.com/v0/b/hbtgram.appspot.com/o/avatar%2Fprofileicon.png?alt=media&token=2bd8b8c7-5f15-422f-8dc8-6b9e7ab2e2c4",
                coverURL: "https://firebasestorage.googleapis.com/v0/b/hbtgram.appspot.com/o/cover%2FalbumCover.jpg?alt=media&token=cdf77771-686e-4c20-9f5f-d01a365352bc",
            }).then(user => {                
...
exports.getUserInfoBasedOnTokenId = catchAsync(async (request, response, next) => {
