...
exports.getAllHBTGramFollows = factory.getAllDocuments(HBTGramFollowModel);

// The function to create new follow
exports.createNewHBTGramFollow = factory.createDocument(HBTGramFollowModel);

// The function to deleta a follow
exports.deleteHBTGramFollow = factory.deleteOne(HBTGramFollowModel);

// The function to delete a follow between the 2 specified users
exports.deleteHBTGramFollowBetween2Users = catchAsync(
