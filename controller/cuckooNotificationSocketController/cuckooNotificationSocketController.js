...
exports.getAllNotificationSocket = factory.getAllDocuments(
  cuckooNotificationSocketModel
);

// The functionn to create new notification socket
exports.createNewNotificationSocket = factory.createDocument(
  cuckooNotificationSocketModel
);

// The function to delete a notification socket
exports.deleteNotificationSocket = catchAsync(
...
exports.checkAndCreateNotificationSocket = catchAsync(
  async (request, response, next) => {
...
exports.updateNotificationSocket = catchAsync(
  async (request, response, next) => {
