...
// Create schema for the confession post object in the database
...
confessionPostSchema.pre("save", async function (next) {
  // The date object
...
// Create the confession post object based on the schema
const ConfessionPost = mongoose.model("ConfessionPost", confessionPostSchema);

// Export the model
module.exports = ConfessionPost;
